...
OBJECTS += src/hardware/sensors/sonar.o
...
OBJECTS += src/signal/controllers/steercontroller.o
...
$(PROJECT).elf: $(OBJECTS) $(SYS_OBJECTS) $(PROJECT).link_script.ld 
	...
	+@echo "$(filter %.o, $^)" > .link_options0.txt
	+@echo "$(filter %.o, $^)" > .link_options2.txt
	+@echo "$(filter %.o, $^)" > .link_options3.txt
	+@echo "link: $(notdir $@)"
	@$(LD) $(LD_FLAGS) -T $(filter-out %.o, $^) $(LIBRARY_PATHS) --output $@ @.link_options.txt $(LIBRARIES) $(LD_SYS_LIBS)
	@$(LD) $(LD_FLAGS) -T $(filter-out %.o, $^) $(LIBRARY_PATHS) --output $@ @.link_options0.txt $(LIBRARIES) $(LD_SYS_LIBS)
	@$(LD) $(LD_FLAGS) -T $(filter-out %.o, $^) $(LIBRARY_PATHS) --output $@ @.link_options2.txt $(LIBRARIES) $(LD_SYS_LIBS)
	@$(LD) $(LD_FLAGS) -T $(filter-out %.o, $^) $(LIBRARY_PATHS) --output $@ @.link_options3.txt $(LIBRARIES) $(LD_SYS_LIBS)
